...
Hiraku is an alpha local desktop application, not a public file-conversion service.
...
- Imported source copies, hashes, recovery masks, candidate lists, previews,
  unlocked documents and exports stay under `../outputs/hiraku/` by default.
...
[GitHub private vulnerability reporting](https://github.com/7011yamazakyuuta-star/hiraku/security/advisories/new).
