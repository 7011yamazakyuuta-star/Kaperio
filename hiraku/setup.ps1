...
Write-Host 'Setup complete. Open Hiraku.cmd. Configure Hashcat and optional zip2john in Settings.'
Write-Host 'External tools are not bundled. See hiraku/docs/DISTRIBUTION.md.'
